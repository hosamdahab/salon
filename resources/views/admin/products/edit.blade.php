                        ...
                        <form method="post" action="{{ route('editSlider') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="margin-top: 20px">
                                ...
                                <textarea type="LONGBLOB" id="arabic" onchange="change()" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" cols="9" rows="9" name="articles_subject_ar" style="margin-top: 10px"><?php echo str_replace('<br />', ' ', $article->articles_subject_ar . "\n"); ?></textarea>
                            ...
                            <div class="form-group" style="margin-top: 20px">
                                ...
                                <textarea type="LONGBLOB" id="english" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp"cols="9" rows="9" name="articles_subject_en" style="margin-top: 10px"> <?php echo str_replace('<br />', ' ', $article->articles_subject_en . "\n"); ?>  </textarea>
                            </div>

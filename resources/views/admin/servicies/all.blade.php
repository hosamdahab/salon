            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <a class="btn btn-success" href="{{ route('addproductsPage', $dep->id) }}" >  اضافة  </a>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($slider->articles_rate=='active')
                                        <a class="btn btn-danger"
                                        href="{{ route('toggleLatestAdded',[$slider->id]) }}">
                                       حظر </a>
                                    ...
                                    <td>
                                        <a class="btn btn-warning"
                                            href="{{ route('editproductsPage',[$slider->id,$dep->id]) }}">
                                           تعديل </a>
                                    </td>
                                    <td>
